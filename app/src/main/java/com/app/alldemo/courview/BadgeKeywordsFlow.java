...
public class BadgeKeywordsFlow extends FrameLayout implements OnGlobalLayoutListener{
    ...
    public BadgeKeywordsFlow(Context context, AttributeSet attrs, int defStyle) {  
        super(context, attrs, defStyle);  
        init();  
    }  
  
    public BadgeKeywordsFlow(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init();  
    }  
  
    public BadgeKeywordsFlow(Context context) {  
        super(context);  
        init();  
    }  
