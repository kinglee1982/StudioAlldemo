...
/**
 * 用于缩放裁剪的自定义ImageView视图，矩形
 * 
 * @author king
 * @time 2014-6-18 下午4:03:28
 */
public class ClipTangImageView extends ImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener{

	private static final int BORDERDISTANCE = ClipTangularView.BORDERDISTANCE;
	...
	public ClipTangImageView(Context context) {
        this(context, null);
    }

    public ClipTangImageView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public ClipTangImageView(Context context, AttributeSet attr, int defStyle) {
	...
	private class AnimatedZoomRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((deltaScale > 1f) && (currentScale < targetZoom))
                ...
                // again
                postOnAnimation(ClipTangImageView.this, this);
