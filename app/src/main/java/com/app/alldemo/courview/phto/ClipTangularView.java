...
public class ClipTangularView extends View {
	...
	public ClipTangularView(Context context) {
		this(context, null);
	}

	public ClipTangularView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ClipTangularView(Context context, AttributeSet attrs, int defStyle) {
