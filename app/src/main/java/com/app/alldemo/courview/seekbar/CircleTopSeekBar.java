...
public class CircleTopSeekBar extends View {
	...
	public CircleTopSeekBar(Context context) {
		this(context, null);
	}

	public CircleTopSeekBar(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public CircleTopSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public interface OnProgressChangedListener {
		void onProgressChanged(CircleTopSeekBar seekBar, int currentProgress,
							   int maxProgress);

		void onDragStart(CircleTopSeekBar seekBar, int currentProgress,
						 int maxProgress);

		void onDraging(CircleTopSeekBar seekBar, int currentProgress,
					   int maxProgress);

		void onDragStop(CircleTopSeekBar seekBar, int currentProgress,
						int maxProgress);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (Math.abs(sweepAngle - degrees) > 180) { // 防止直接从起点逆时针滑动
				return true;
			}
	...
	private void notifyDragStop() {
		...
		if (onProgressChangedListener != null) {
			onProgressChangedListener.onDragStop(CircleTopSeekBar.this,
	...
	private void notifyDragStart() {
		...
		if (onProgressChangedListener != null) {
			onProgressChangedListener.onDragStart(CircleTopSeekBar.this,
					currentProgress, maxProgress);
		}
	}
	...
	private void notifyDraging() {
		if (onProgressChangedListener != null) {
			onProgressChangedListener.onDraging(CircleTopSeekBar.this,
					currentProgress, maxProgress);
		}
	}
	...
	private void notifyProgressChanged() {
		if (onProgressChangedListener != null) {
			onProgressChangedListener.onProgressChanged(CircleTopSeekBar.this,
					currentProgress, maxProgress);
		}
	}
