...
public class WheelGalleryView extends TosGallery {
    /**
     * The selector.
     */
     ...
     * @param attrs
     */
    public WheelGalleryView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * @param defStyle
     */
    public WheelGalleryView(Context context, AttributeSet attrs, int defStyle) {
...
//        drawShadows(canvas);
    ...
    /**
     * @see com.app.alldemo.wheeltest.nj1s.lib.widget.TosGallery#setSelectedPositionInt(int)
     */
    @Override
