...
import com.app.alldemo.courview.phto.ClipCircleImageView;
...
public class CutCicleImagActivity extends Activity {
    private ClipCircleImageView imageView;
    private TextView cutupImagConfrim,cutupImagCancel;
    private String filePath;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cut_circle);
        init();
        findUI();
        initView();
    }
    ...
    private void findUI(){
        imageView=(ClipCircleImageView)findViewById(R.id.src_pic);
