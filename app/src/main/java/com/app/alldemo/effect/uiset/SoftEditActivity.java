...
import com.app.alldemo.courview.SoftLayoutView;
import com.app.alldemo.utils.LangUtils;
import com.app.alldemo.utils.MyLog;

import java.util.regex.Pattern;

public class SoftEditActivity extends Activity {
    private EditText editext;
    private SoftLayoutView softlayout;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_soft_edit);
        findUI();
        test2();
    }
    private void findUI(){
        editext=(EditText)findViewById(R.id.editext);
        softlayout=(SoftLayoutView)findViewById(R.id.softlayout);
        editext.setText("");
    }
    private void test2(){
        //模拟编辑框不可编辑效果
